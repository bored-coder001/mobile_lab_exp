...
plot_y = fun('y_axis_correct.xls',2,np.array([-0.305831373,0.051700756,-0.045432236
]),np.linspace(5.5,6.72,1000))

plot_y2 = fun('y_axis_correct.xls',1,np.array([-2.630726576,-34.06024933,0.621257782]),np.linspace(1.76,2.48,1000))
